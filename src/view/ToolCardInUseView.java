...
/// Initializing Variables
		...
		this.getChildren().addAll(background, toolcardCardImage, confirmButton, confirmButtonText, favortokensPlayer1,
				favortokensPlayer2, favortokensPlayer3, favortokensPlayer4, backButton, backButtonText);
